...
""" Userbot module for managing events.
 ...
 One of the main components of the amebot. """
...
from amebot import bot, BOTLOG_CHATID, LOGSPAMMER
                ...
                if not disable_errors:
                    ...
                    if LOGSPAMMER:
                        ...
                        await check.client.respond(
                            ...
                            "`Sorry, my amebot has crashed😔, check logs for more info.\

                        \nThe error logs are stored in the amebot log chat.`"
