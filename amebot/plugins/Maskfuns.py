...
@bot.on(amebot_cmd(pattern=r"cmask"))
...
@bot.on(amebot_cmd(pattern=r"thug"))
async def scan(event):
    path = "dcobra"
...
@bot.on(amebot_cmd(pattern=r"pro"))
async def scan(event):
    path = "dcobra"
...
@bot.on(amebot_cmd(pattern=r"oxy"))
async def scan(event):
    path = "dcobra"
...
@bot.on(amebot_cmd(pattern=r"gold"))
async def scan(event):
    path = "dcobra"
...
@bot.on(amebot_cmd(pattern=r"old"))
async def scan(event):
    path = "dcobra"
...
@bot.on(amebot_cmd(pattern=r"krish"))
async def scan(event):
    path = "dcobra"
...
@bot.on(amebot_cmd(pattern=r"cprotect"))
async def scan(event):
    path = "dcobra"
